...
const TERMS = [
  ...
  ['Top-bottom spread (TB1/TB2/TB4)', 'the sum of a day’s n highest hourly day-ahead prices minus the sum of its n lowest — what an n-hour storage system cycling once a day would have captured in the day-ahead auction alone. A price-spread statistic, NOT battery revenue: real systems also earn in intraday, balancing and ancillary markets (GB two-hour systems earned about 1.4× TB2 in 2025), and real trading doesn’t capture the full spread either.'],
  ['Coupled border', 'two neighbouring zones cleared at (nearly) the same day-ahead price — the interconnector had room, so they traded as one market. A low coupled share means they clear apart, and the spread is the story. “Within €1/MWh” is ACER’s own “full price convergence” band, so the desk’s number is directly comparable to the regulator’s.'],
  ['Convergence bands (ACER)', 'the PRICE CONVERGENCE panel sorts every border-hour into ACER’s Market-Monitoring-Report bands: full (spread ≤ €1/MWh), moderate (€1–10), low (> €10). ACER’s own caveat travels with it: full convergence is NOT the objective — reaching 100% would require overinvesting in the grid. Swiss borders sit outside EU market coupling and converge rarely by design; they are flagged and kept out of the headline.'],
